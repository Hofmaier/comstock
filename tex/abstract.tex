...
Further the system is \gls{scalable} for big data because Solr is optimized for to search large volumes of data and co-occurrence can be computed at scale with Apache Mahout's \verb|spark-itemsimilarity| job.
